...
/**
 * @brief Class Production request to be done by Headquarters
 */
...
public:
	...
	* @param the Production_Request pr2 to the compared
	*
	* @return true if the Production_Requests is less than pr2 and false otherwise
	*/
	bool operator < (const Production_Request & pr2) const;

	/**
	 * @brief Changes the Deadline of the Production_Request
	 *
	 * @param year year of the new Deadline
	 *
	 * @param month month of the new Deadline
	 *
	 * @param day day of the new Deadline
	 *
	 * @return void
	 */
